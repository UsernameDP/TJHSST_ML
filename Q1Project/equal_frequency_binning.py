...
def equal_frequency_binning_inputs(input_csv, output_csv=None, class_name=None):
    if class_name == None:
    ...
    for col in numeric_cols:
        ...
        actual_bins = min(
            int(
                input(f"Attribute {col} has {unique_vals}, how many bins do you want? ")
            ),
            unique_vals,
        )
...
if __name__ == "__main__":
    ...
    input_file = args[0]
    class_name = args[1]
    equal_frequency_binning_inputs(input_file, class_name=class_name)
